# TODO: Acknowledge and verify modules/specs/AIFoundryOpenAI.json
...
$appInsightsId = $env:APPINSIGHTS_ID
...
az deployment group create `
  ...
  --parameters appInsightsInstrumentationKey=$appInsightsInstrumentationKey `
  --parameters appInsightsId=$appInsightsId `
  --what-if